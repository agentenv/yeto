# Kappa zero-shot Round 3: frozen trajectory-instrumentation protocol

**Status:** FROZEN BEFORE ANY ROUND-3 RUN OR PROBE

**Freeze date:** 2026-07-27 (America/Los_Angeles)
...
change the panel or estimator. Results and the verdict are continuously
