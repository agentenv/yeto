...
def make_miles_island_task(
    ...
    cybergym_env = {
        "CYBERGYM_URL": getattr(args, "cybergym_url", "http://127.0.0.1:8666"),
        "CYBERGYM_AGENT_ID": getattr(args, "cybergym_agent_id", "yeto_agent"),
        "CYBERGYM_TIMEOUT": str(getattr(args, "cybergym_timeout", 60.0)),
    }
    if getattr(args, "cybergym_api_key", None):
        cybergym_env["CYBERGYM_API_KEY"] = args.cybergym_api_key
    task = sky.Task(
