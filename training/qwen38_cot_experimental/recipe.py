...
def make_recipe(*, model_dir, manifest, index_path, index_sha256, output_dir,
    ...
    # Baseline's 32k validation filter would silently drop long validation traces.
    config["validation_dataset"]["max_input_tokens"] = 262144
    ...
    config["wandb"]["name"] = "qwen38-27b-generated-cot-masked-" + phase
