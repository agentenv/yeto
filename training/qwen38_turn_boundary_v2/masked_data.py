...
MAX_TOKENS = 262144
MANIFEST_SCHEMA = "qwen38-generated-cot-masked-turn-boundary-manifest/v2"
INDEX_SCHEMA = "qwen38-generated-cot-masked-turn-boundary-index/v2"
TRAINING_CONTRACT = "qwen38-xhigh-generated-cot-loss-zero-turn-boundary/v2"
...
DATASET_TARGET = "training.qwen38_turn_boundary_v2.masked_data.GeneratedMaskedTokenDataset"
COLLATOR_TARGET = "training.qwen38_turn_boundary_v2.masked_data.collate_exact"
SEQUENCE_POLICY = "first_262144_tokens_drop_remainder/v1"
RENDERER_VERSION = "qwen3.8-xhigh-generated-cot-input-only-turn-boundary/v2"
...
def read_manifest(path):
    ...
    if manifest.get("full_export"):
        if (manifest.get("all_frozen_generations_accounted_for") is not True
                ...
                or manifest.get("included_valid_candidate_count", -1) + manifest.get("excluded_valid_candidate_count", -1)
...
def build_index(manifest_path, output, *, workers=1):
    ...
    with ProcessPoolExecutor(max_workers=min(workers,len(jobs))) as pool:
        for job, (split, (refs, source_groups, gaps)) in zip(jobs,pool.map(_scan_index_job,jobs)):
