...
PRESETS: dict[str, Arm] = {
    ...
    # Exploratory online PTI screens.  Each pair differs only in the causal
    # direction selector feeding the same memoryless SGD-0.28 outer kernel.
    # These are paired-by-seed online screens, not capture-v2 CRN evidence.
    "pti_m1_stock": Arm(
        "pti_m1_stock",
        m=1,
        fragments=4,
