#!/usr/bin/env python3
"""Synchronous FSDP baseline for comparison against Decoupled DiLoCo.

Mirrors the DiLoCo arm's topology exactly — 3x gr6.4xlarge (1x L4 each) in
...
def main() -> int:
    ...
    task.set_resources(
        sky.Resources(
            infra="aws/us-west-2",
            accelerators="L4:1",
            # Same instance type as the DiLoCo learners (and the best spot
