#!/usr/bin/env python3
"""Run the frozen G13 Pythia/UltraChat monotonicity analyzer."""
...
def main() -> int:
    ...
    readout = analyze_scan(read_json(args.manifest), "v13", args.result_root)
    write_json_atomic(args.output, readout)
    append_note(args.note, f"G13 VERDICT: {readout['gate']['verdict']}")
    print(
        json.dumps(
