    ...
    records = [
        {
            ...
            "random_drop_strict_bad_count_utility": -0.002,
            "random_drop_strict_bad_count_strict_negative": False,
            "random_drop_strict_bad_count_selected_count": 3,
        },
        {
            "candidate_count": 2,
            ...
            "random_positive_count_strict_negative": False,
            "random_positive_count_selected_count": 2,
            "random_drop_strict_bad_count_utility": 0.01,
            "random_drop_strict_bad_count_strict_negative": False,
            "random_drop_strict_bad_count_selected_count": 2,
        },
    ]
